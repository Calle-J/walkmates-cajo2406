...
|---------------------------|------------|-----------------|
| Just below lower boundary | 9.99       | Rejected        |
| Lower boundary            | 10.00      | Accepted        |
| Just above lower boundary | 10.01      | Accepted        |
| Just below upper boundary | 4 999.99   | Accepted        |
